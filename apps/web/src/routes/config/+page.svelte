...
<section class="flex flex-col gap-14">
	...
	<section id="models" class="scroll-mt-28">
		...
		<p class="mt-2 max-w-2xl text-sm bc-prose">
			Providers require credentials configured in OpenCode. Run <code class="bc-inlineCode">btca auth</code>
			(or <code class="bc-inlineCode">opencode auth</code>) to connect a provider, or edit your OpenCode
			config directly.
		</p>
